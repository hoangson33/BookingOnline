...
<body>
	...
	<section class="hotel-banner vrsn-2 pos-relative">
				...
				<div class="row">
					<div class="col-12">
						<div class="banner-title text-center">
							<h5 class="title-20 color-ff text-uppercase">We're Here To
								Help You Enjoy Your Stay</h5>
							<h2 class="fw-700 text-uppercase color-fbc playfair">Laxury
								Trip Hotel & Resort</h2>
						</div>
						<form action="#">
							<ul class="align-center-center">
	...
	<div id="header-2" class="sticky-menu2">
		<header class="hotel-header vrsn-2">
				...
				<div class="row">
					<div class="col-12">
						<div id="menuzord" class="menuzord p-0">
							...
							<a href="" class="book-btn btn-default">Book Now <i
	...
	<section class="welcome-section vrsn-2 section-padding">
		<div class="container">
			...
			<div class="row memebership-wrapper">
				...
				<div class="col-lg-4">
					<div class="membership-area text-center">
						<span>Want to our</span>
						<h4 class="playfair">Membership?</h4>
						<a href="#" class="btn-default read-more solid-bg-btn"><span>Sign
								Up Now <i class="ion-ios-arrow-thin-right"></i>
						</span></a>
					</div>
				</div>
				<div class="col-lg-4">
	...
	<section class="hotel-room vrsn-2 section-padding">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="section-title text-center">
						<h2 class="color-1c pos-relative text-capitalize">Best Rooms</h2>
	...
	<section class="home2-cta">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="cta-content align-row-spacebetween">
						<div class="content-txt">
							<h3 class="pos-relative playfair color-bf9">Enjoy Great
								Times with us</h3>
							<p class="pt-20">Praesent faucibus tristique leo, eu lacinia
								neque condimentum in. Maecenas orci purus, aliquet lobortis.</p>
						</div>
						<a class="cta-button" href="#">Contact Now</a>
					</div>
				</div>
				<!--/col-->
			</div>
	...
	<section class="room-carousel vrsn-2 section-padding">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="room-carousel-wrapper pos-relative">
						<div class="room-info-wrapper carousel-info-v1">
							<div class="room-info">
								<h4 class="color-33 playfair">Spa and Beauty Center</h4>
								<span class="color-1c text-uppercase tag">Skin Care</span><span
									class="divider"></span>
								<p>Pellentesque nulla magna, accumsan sed ante quis, gravida
									feugiat turpis. Vivamus et fringilla ligula. Pellentesque nulla
									magna, accumsan sed ante quis, gravida feugiat turpis</p>
								<a href="#" class="btn-default book-now">READ MORE</a>
							</div>
							<div class="room-info">
								<h4 class="color-33 playfair">Luxurious Room for Family-2</h4>
								<span class="color-1c text-uppercase tag">Relaxation</span><span
									class="divider"></span>
								<p>Pellentesque nulla magna, accumsan sed ante quis, gravida
									feugiat turpis. Vivamus et fringilla ligula. Pellentesque nulla
									magna, accumsan sed ante quis, gravida feugiat turpis</p>
	...
	<section class="room-carousel vrsn-2 reverse section-padding">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="room-carousel-wrapper pos-relative">
						<div class="room-info-wrapper carousel-info-v2">
							<div class="room-info">
								<h4 class="color-33 playfair">Luxurious Hotel & Resort</h4>
								<span class="color-1c text-uppercase tag">Relaxation</span><span
									class="divider"></span>
								<p>Pellentesque nulla magna, accumsan sed ante quis, gravida
									feugiat turpis. Vivamus et fringilla ligula. Pellentesque nulla
	...
	<section class="dining-service align-row-left-center">
		...
		<div class="dining-content pos-relative">
			<span class="divider"></span>
			<h4 class="playfair color-bf9">Dining Service</h4>
			<span class="text-uppercase">BEST RESTAURANTS</span>
			<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
				blandit, ante vitae luctus vehicula, nunc purus iaculis massa, nec
				aliquet nunc ipsum sit amet neque. Quisque viverra lorem quis ante
				rutrum, vestibulum elementum leo dignissim. Suspendisse euismod</p>
			<a href="#" class="btn-default solid-bg-btn pos-relative"><span>View
					Details <i class="ion-android-arrow-dropright"></i>
			</span></a>
		</div>
	</section>
	<!-- =======================================         ==End related service section==      =======================================-->
	<!-- =======================================         ==Start video section==      =======================================-->
	<section class="hotel-video vrsn-2">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="video-content text-center align-center-center">
						<span class="line display-block bg-bf9"></span>
						<p class="color-77 mt-20 text-uppercase">LUXURY HOTEL & BEST
							RESORT</p>
						<h2 class="color-22 fw-300 pb-50 pt-20 playfair">Relax and
							Enjoy with our Hotel & Resort</h2>
						<a class="venobox display-inline color-ff radius-100p"
	...
	<section class="hotel-testimonial2 section-padding pos-relative">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
				<div class="col-12">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<div class="testimonial-wrapper owl-carousel t-carousel3">
						<div class="single-testimonial text-center">
							<div class="author-info align-row-center-center">
							...
							<p class="author-comment color-66 pt-30">Pellentesque sem
								leo, placerat ac venenatis et, gravida vitae tortor. Duis
								scelerisque mattis quam, eget dictum quam lobortis id.
								Vestibulum ut dolor id sapien volutpat sagittis nec in erat.</p>
						</div>
						<!--testimonial-2-->
						<div class="single-testimonial text-center">
							<div class="author-info align-row-center-center">
				...
				<div class="row">
					<div class="col-12">
						<div class="contact-area text-center">
							<h4 class="title-36 lato color-22">Get latest news from us!</h4>
							<p class="subtitle lato">We never spam your email</p>
							<form action="#" method="post" class="clearfix">
								<input name="search" placeholder="Enter your email"
									type="search">
								<button>
								...
								<div class="contact-address">
									<p class="address">
										<i class="flaticon-placeholder"></i><span
											class="text-uppercase">ADDRESS:</span>28 Green Tower, Street
										Name New York City, USA
									</p>
									<p class="phone">
										<i class="flaticon-phone-call"></i><span
											class="text-uppercase">Phone:</span>+84 846 250 592
									</p>
									<p class="email">
						...
						<div class="col-xl-4 offset-xl-2 col-md-5">
							<div class="single-widget widget1 text-center">
								...
								<ul class="social-connect display-inline">
									...
									<li><a href="#" title="Vimeo" target="_blank"><i
