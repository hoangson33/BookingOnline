		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form method="post" action="${pageContext.request.contextPath }/customer/editpass" class="signin-form">
	            	...
	            	<div class="w-50">
		            	<label class="checkbox-wrap checkbox-primary">
								...
								<div class="w-50 text-md-right">
									<a href="${pageContext.request.contextPath }/customer" style="color: #fff">Back</a>
								</div>
	            </div>
	          </form>
		      </div>
