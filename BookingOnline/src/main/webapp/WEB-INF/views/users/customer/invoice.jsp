...
<div class="container rounded bg-white mt-5 mb-5" style="width: 5000px; height: 850px">
    <div class="row tab-content">
   			<ul class="nav nav-tabs">
			    <li class="active"><a href="${pageContext.request.contextPath }/home/welcomeCustomer"><i class="fa fa-home fa-2x" style="color: #87CEFA;"></i> Home</a></li>
        ...
        <div id="myDIV1" onscroll="myFunction1()" class="col-md-9 border-right tab-pane fade">
            <div id="content" class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a style="text-decoration: none" href="${pageContext.request.contextPath }/customer">Profile </a><i class="fa fa-arrow-right"></i> 
                    <a style="text-decoration: none" href="${pageContext.request.contextPath }/customer/invoice/${account.idAcc}">Invoice </a><i class="fa fa-arrow-right"></i>
