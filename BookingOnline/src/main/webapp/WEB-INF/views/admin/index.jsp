...
<mt:layout_admin title="Index">
	...
	<div id="curved-line-chart"
								class="flot-chart-sts flot-chart curved-chart-statistic"></div>
	</div>
	</div>
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
	...
	<li class="text-right sp-cn-r"><i class="fa fa-level-up"
									aria-hidden="true"></i> <span class="counter sales-sts-ctn">8659</span></li>
	</ul>
	</div>
	...
	<li class="text-right"><i class="fa fa-level-up"
									aria-hidden="true"></i> <span class="counter sales-sts-ctn">7469</span></li>
	</ul>
	</div>
	<div class="white-box analytics-info-cs mg-b-30">
	...
	<li class="text-right"><i class="fa fa-level-up"
									aria-hidden="true"></i> <span class="counter sales-sts-ctn">6011</span></li>
	</ul>
	</div>
	...
	<h3 class="box-title">
								<small
									class="pull-right m-t-10 text-danger last-month-sc cl-two"><i
	...
	<a href="#"><img
								src="${pageContext.request.contextPath }/resources/layout_admin/img/new-product/5.png"
								alt=""></a>
	...
	<div id="line-chart"
								class="flot-chart flot-chart-sts line-chart-statistic"></div>
	</div>
	</div>
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
	...
	<h2>
									<span class="counter">60</span>/20</h2>
	...
	<img
									src="${pageContext.request.contextPath }/resources/layout_admin/img/notification/5.jpg"
	...
	<div class="perso-img">
	<img
										src="${pageContext.request.contextPath }/resources/layout_admin/img/notification/6.jpg"
										class="img-circle circle-border m-b-md" alt="profile">
	</div>
	...
	<img
									src="${pageContext.request.contextPath }/resources/layout_admin/img/contact/2.jpg"
									class="img-circle circle-border m-b-md" alt="profile">
	<div class="social-widget-result">
	<span>100 Tweets</span> |
	<span>350 Following</span> |
