                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4>Room List Approval</h4>
                            <div class="add-product" >
                                <a style="color: green;" href="${pageContext.request.contextPath }/admin/room-list">Room List</a>
                            </div>
                            <table>
                                <tr>
                                    <th>Image</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a ><i style="color: green;" class="fa fa-check" aria-hidden="true"></i></a>
                                        <button id="myBtn">
                                ...
                                <s:form  method="get" action="${pageContext.request.contextPath }/admin/deleteRoom/${roomlist.idRoom } ">    
                                <!-- The Modal -->
